    ...
    <nav class="bg-white border-b border-gray-200 shadow-sm sticky top-0 z-50">
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-cta">
            <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white">
                ...
                <li><a href="{{-- route('pengumuman.index') --}}" class="block py-2 px-3 md:p-0 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-teal-600">Pengumuman</a></li>
                <li><a href="{{-- route('galeri.index') --}}" class="block py-2 px-3 md:p-0 text-teal-600 rounded md:bg-transparent" aria-current="page">Galeri</a></li>
